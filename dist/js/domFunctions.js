//import { getWeatherFromCoords } from './dataFunction';
...
const displayCurrentConditions = currentConditionArray => {
  const ccContainer = document.getElementById('currentForecast-condition');
...
const createDailyForecastDivs = dayWeather => {
  const dayAbbreviationText = getDayAbbriviation(dayWeather.dt);
